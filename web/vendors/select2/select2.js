    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            selection.delegate("abbr", "mousedown", this.bind(function (e) {
                ...
                if ($(e.target).closest('.select2-container').hasClass('selectUsageService')) {
                    var selectUsageServiceBlock = $(e.target).closest('.select2-container');
                    
                    if(selectUsageServiceBlock.closest('.control-group').next().find('.controls div.selectUsageType').length > 0 ) {
                        $('.controls div.selectUsageType .select2-search-choice-close').mousedown();
                        $('.controls div.selectUsageType .select2-search-choice-close').hide();
                    }
                }
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        clearSearch: function () {
            ...
            if (placeholder !== undefined  && this.getVal().length === 0 && this.search.hasClass("select2-focused") === false) {
                ...
                //this.search.val(" ")
				this.search.attr('placeholder', '').width(10);
            }
